...
AXIS_MAP = {'azimuth': 0, 'beam': 1, 'layer': 2}
...
class DatasetTPC(Dataset):
    ...
    def __init__(self,
        ...
        print(f'load TPC data in axis order {axis_order}')
    ...
    def __getitem__(self, index):
        ...
        datum = torch.tensor(np.load(fname), dtype=torch.float32)
